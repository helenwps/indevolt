/* Publish by EComposer at 2025-04-21 10:35:31*/
                (function(){
                    const Func = (function() {
                        'use strict';
window.__ectimmers = window.__ectimmers ||{};window.__ectimmers["ecom-exzfe7a2s6a"]=  window.__ectimmers["ecom-exzfe7a2s6a"] || {};
                ...
                const handleAnimation = function(_this) {
                    ...
                    $btn_wrapper.forEach(function(btn) {
                        let intervalTime = parseInt(_this.settings.animation_loop_time) * 1000 || 6000,
                            animTime = 1000;window.__ectimmers["ecom-9h7myhz3k3"]["k93cu6i6o"] = setInterval(function() {
