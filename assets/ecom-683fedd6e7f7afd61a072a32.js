/* Publish by EComposer at 2025-06-09 07:48:48*/
                (function(){
                    const Func = (function() {
                        'use strict';
                ...
                const handleAnimation = function(_this) {
                    ...
                    $btn_wrapper.forEach(function(btn) {
                        let intervalTime = parseInt(_this.settings.animation_loop_time) * 1000 || 6000,
                            animTime = 1000;window.__ectimmers["ecom-m6zl46erhk"]["cxr3ufu2y"] = setInterval(function() {
