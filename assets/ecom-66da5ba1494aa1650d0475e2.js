/* Publish by EComposer at 2025-06-16 11:02:16*/
                (function(){
                    const Func = (function() {
                        'use strict';
window.__ectimmers = window.__ectimmers ||{};window.__ectimmers["ecom-sby07zkwoom"]=  window.__ectimmers["ecom-sby07zkwoom"] || {};
if(!this.$el)return;const e=this.$el,i=e.querySelector(".ecom-text_view-more-btn"),t=e.querySelector(".ecom-text_view-less-btn"),n=e.querySelector(".text-content.ecom-html");!n||(i&&i.addEventListener("click",()=>{n.classList.remove("ecom-text--is-mark"),n.style.maxHeight="",i.style.display="none",t.style.display=""}),t&&t.addEventListener("click",()=>{n.classList.add("ecom-text--is-mark"),n.style.maxHeight="var(--ecom-text-height)",t.style.display="none",i.style.display=""}))
                        ...
                        document.querySelectorAll('.ecom-qblru9cveoa').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-qblru9cveoa', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-ldou51fmhco').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-ldou51fmhco', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-0rl5csi7219').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-0rl5csi7219', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-pe633l3kjh').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-pe633l3kjh', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-i1hp0on1ky').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-i1hp0on1ky', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-4896l7d1rq').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-4896l7d1rq', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-gylg3snsihn').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-gylg3snsihn', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-z20o94f8ag').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-z20o94f8ag', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-wymieotxbqb').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-wymieotxbqb', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-d6w50xj2kvg').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-d6w50xj2kvg', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-5d2hbt4hksk').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-5d2hbt4hksk', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-67wl5nrwxbx').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-67wl5nrwxbx', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-netlb7qiu9g').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-netlb7qiu9g', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-h3js5n2der').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-h3js5n2der', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-9g5lc54d174').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-9g5lc54d174', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-z2g6wtog7ne').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-z2g6wtog7ne', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-cxvjrj2lp5f').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-cxvjrj2lp5f', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-r3sj0u04fn').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-r3sj0u04fn', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-44ji11qcs4z').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-44ji11qcs4z', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-41nl9c6gpyz').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-41nl9c6gpyz', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-031o954adhnd').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-031o954adhnd', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-o6p72j0o9yd').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-o6p72j0o9yd', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-efuy95y8ag').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-efuy95y8ag', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-8gz8s9himkn').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-8gz8s9himkn', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-tuzygudshmb').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-tuzygudshmb', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-k6lrkvcvjm').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-k6lrkvcvjm', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-fcinoaa5obe').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-fcinoaa5obe', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-asqjd4acim').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-asqjd4acim', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-qi26at8tci').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-qi26at8tci', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-acw87s4aj4i').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-acw87s4aj4i', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-oy8l8fyyzxe').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-oy8l8fyyzxe', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-o5ptyemrrfh').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-o5ptyemrrfh', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-8a1b8ge38b').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-8a1b8ge38b', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-fa611hdf8ur').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-fa611hdf8ur', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-g9vqzmhpbjm').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-g9vqzmhpbjm', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-euu451j3xr9').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-euu451j3xr9', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-4ekw8iiqt8d').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-4ekw8iiqt8d', settings: {},isLive: true});
                        });
                        ...
                        document.querySelectorAll('.ecom-9m4ixtmlmg7').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-9m4ixtmlmg7', settings: {},isLive: true});
                        });
                        ...
                        document.querySelectorAll('.ecom-i3vb1ixv93j').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-i3vb1ixv93j', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-li2a2pw14yc').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-li2a2pw14yc', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-nk9mbvwu5ur').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-nk9mbvwu5ur', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-5zg18cj3d8w').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-5zg18cj3d8w', settings: {},isLive: true});
                        });
                        ...
                        document.querySelectorAll('.ecom-q1702psfj3l').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-q1702psfj3l', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-jdjnatmzxgb').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-jdjnatmzxgb', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-9qfr3c0ht3u').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-9qfr3c0ht3u', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-c6l5lj6udi8').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-c6l5lj6udi8', settings: {},isLive: true});
                        });
...
if(!this.$el)return!1;const e=this.$el;this.settings.animation&&function(t){if(!e)return;const n=e.querySelector(".ecom__element--button");if(!n)return;let s=parseInt(t.settings.animation_loop_time)*1e3||6e3,o=1e3;window.__ectimmers["ecom-0c2y8lkoveww"]["5nregmpz2"] = setInterval(function(){n.classList.add("animated"),setTimeout(function(){n.classList.remove("animated")},o)},s)}(this);var i=e.querySelector(".ecom__element--button");this.isLive&&i&&i.dataset.ecTrackingId&&i.addEventListener("click",function(t){if(window.Shopify.analytics){t.preventDefault();let n=document.createElement("div");document.body.appendChild(n),n.click();let s=window.EComposer.PAGE||window.EComposer.TEMPLATE||window.EComposer.SECTION||window.EComposer.BLOCK||{};const o=Object.assign({button_id:i.id,tracking_id:i.dataset.ecTrackingId},s);Shopify.analytics.publish("ec_custom_events",o),i.cloneNode(!0).click()}},{once:!0}),this.isLive&&i&&i.dataset.eventTrackingFb&&i.addEventListener("click",function(t){window.fbq&&window.fbq("track",`${i.dataset.eventTrackingFb}`)},{once:!0})
                        ...
                        document.querySelectorAll('.ecom-ffovwmn89z').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-ffovwmn89z', settings: {"animation":false},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-ufj3xnb2v9o').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-ufj3xnb2v9o', settings: {"animation":false},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-wha3asv4db').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-wha3asv4db', settings: {"animation":false},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-5w8lpztad9s').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-5w8lpztad9s', settings: {"animation":false},isLive: true});
                        });
...
if(!this.$el)return!1;const e=this.$el;let i=e.closest(".ecom-product-form--single");if(!i){const n=e.closest(".ecom-builder");n&&(i=n.querySelector(".ecom-product-form--single"))}if(!i)return!1;if(this.isLive){let n=i.querySelector("select[name=id]");const s=e.querySelector(".ecom-product-single__buy_it_now_btn--checkout"),o=i.dataset.product_id;if(!o)return;let a=null;const r=i.querySelector("[id^=product-json-"+o+"]");if(!r)return;try{a=JSON.parse(r.innerHTML)}catch(c){return}s&&s.addEventListener("click",function(c){c.preventDefault();let m=1;i.querySelector("[name=quantity]")&&(m=i.querySelector("[name=quantity]").value);let l=i.querySelector("select[name=id]")||i.querySelector("input[name=id]");l||console.warn("EC error: Select id or input id not found!");let h=l.value,y=a.variants.find(b=>b.id==h);if(!y||y.available===!1)return;window.Shopify.analytics&&Shopify.analytics.publish("ec_buy_now",{cartLine:{cost:{totalAmount:{amount:y.price*m,currencyCode:window.Shopify.currency.active}},merchandise:{id:y.id,image:y.image,price:{amount:y.price,currencyCode:window.Shopify.currency.active},product:{id:a.id,title:a.title,vendor:a.vendor},sku:y.sku,title:y.title},quantity:m}});let g=`${window.EComposer.routes.cart_url}/${h}:${m}`;if(window.location.search.includes("selling_plan")){const b=/selling_plan=(\d+)/,u=window.location.search.match(b);if(u){const x=u[1];g=`${window.EComposer.routes.cart_url}/clear?return_to=/cart/add?items[][id]=${h}%26items[][quantity]=${m}%26items[][selling_plan]=${x}%26return_to=/checkout`}}location.href=g}),a.available||(s.classList.add("ecom-disable-buy"),s.disabled=!0),n&&n.addEventListener("change",function(){let c=this.value;if(!c)return;a.variants.find(l=>l.id==c).available===!1?(s.classList.add("ecom-disable-buy"),s.disabled=!0):(s.classList.remove("ecom-disable-buy"),s.disabled=!1)})}const t=function(n){if(!e)return;const s=e.querySelector(".ecom-product-single__buy_it_now_btn--checkout");if(!s)return;let o=parseInt(n.settings.animation_loop_time)*1e3||6e3,a=1e3;window.__ectimmers["ecom-qozj8l9w3c"]["ofoy57o1d"] = setInterval(function(){s.classList.add("animated"),setTimeout(function(){s.classList.remove("animated")},a)},o)};this.settings.animation&&t(this)
                ...
                (function(){
                    const Func = (function() {
                        'use strict';
window.__ectimmers = window.__ectimmers ||{};window.__ectimmers["ecom-3vn5gknehip"]=  window.__ectimmers["ecom-3vn5gknehip"] || {};
if(this.settings.link==="lightbox"&&this.settings.lightbox==="yes"&&window.EComModal&&this.$el){var e=this.$el.querySelector("[ecom-modal]");new window.EComModal(e,{cssClass:["ecom-container-lightbox-"+this.id]})}let i=this.$el;if(!i)return;function t(s){const o=s.getBoundingClientRect();return o.top>=0&&o.left>=0&&o.bottom-s.offsetHeight/2<=(window.innerHeight||document.documentElement.clientHeight)&&o.right<=(window.innerWidth||document.documentElement.clientWidth)}function n(){let s=i.querySelector(".ecom-element.ecom-base-image"),o=i.closest(".core__row--columns");s&&(t(s)?(s.classList.add("image-highlight"),o.setAttribute("style","z-index: unset")):(s.classList.remove("image-highlight"),o.setAttribute("style","z-index: 1")))}this.settings.highligh_on_viewport&&window.addEventListener("scroll",function(){n()})
                        ...
                        document.querySelectorAll('.ecom-3p9ee8pvok4').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-3p9ee8pvok4', settings: {"link":"none","lightbox":"no","highligh_on_viewport":false},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-xw1rngsummh').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-xw1rngsummh', settings: {"link":"none","lightbox":"no","highligh_on_viewport":false},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-p3y1pxlswuc').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-p3y1pxlswuc', settings: {"link":"none","lightbox":"no","highligh_on_viewport":false},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-iepg2xcybtr').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-iepg2xcybtr', settings: {"link":"none","lightbox":"no","highligh_on_viewport":false},isLive: true});
                        });
                        ...
                        document.querySelectorAll('.ecom-uc0b5kdo2yk').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-uc0b5kdo2yk', settings: {"link":"none","lightbox":"no","highligh_on_viewport":false},isLive: true});
                        });
                        ...
                        document.querySelectorAll('.ecom-14okqjw6cc1').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-14okqjw6cc1', settings: {"link":"none","lightbox":"no","highligh_on_viewport":false},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-hcnfjibb5f').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-hcnfjibb5f', settings: {"link":"none","lightbox":"no","highligh_on_viewport":false},isLive: true});
                        });
                        ...
                        document.querySelectorAll('.ecom-8niv8gusytc').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-8niv8gusytc', settings: {"link":"none","lightbox":"no","highligh_on_viewport":false},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-6trvg4uuzuk').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-6trvg4uuzuk', settings: {"link":"none","lightbox":"no","highligh_on_viewport":false},isLive: true});
                        });
                ...
                (function(){
                    const Func = (function() {
                        'use strict';
window.__ectimmers = window.__ectimmers ||{};window.__ectimmers["ecom-fsaoyzni8z9"]=  window.__ectimmers["ecom-fsaoyzni8z9"] || {};
if(!this.settings||!this.$el)return;const e=this.$el,i=this.isLive,t=this.settings.loop,n=this.settings.autoplay,s=this.settings.lazyload||!1,o=this.settings.player_controls||!1,a=this.settings.pause_on_hover||!1,r=this.settings.click_to_play_pause,c=this.settings.play_on_lightbox||!1,m=1;let l=e.querySelector(".ecom-video_overlay-icon");const h=e.querySelector(".ecom-video-poster");let y;y=l&&l.querySelector(".ecom-video-icon-play");const g=e.querySelector(".ecom-element_video-iframe");s&&setTimeout(function(){b(g)},500);function b(L){let z={root:null,rootMargin:"0px",threshold:.5};new IntersectionObserver($,z).observe(L)}function u(L,z){let M={handleMouseenter:T,handleMouseleave:S,handleEnded:q};function T(){L.readyState>=m&&L.pause()}function S(){L.readyState>=m&&L.play()}function q(){x(L,M)}if(a){L.addEventListener("mouseenter",T),L.addEventListener("mouseleave",S);let P=e.querySelector(".ecom-video_link-extra");P&&P.href&&(P.addEventListener("mouseenter",T),P.addEventListener("mouseleave",S)),z||L.addEventListener("ended",q)}}function x(L,z){if(z){const{handleMouseenter:M,handleMouseleave:T,handleEnded:S}=z;let q=e.querySelector(".ecom-video_link-extra");L.removeEventListener("mouseenter",M),L.removeEventListener("mouseleave",T),L.removeEventListener("ended",S),q&&q.href&&(q.removeEventListener("mouseenter",M),q.removeEventListener("mouseleave",T))}}function $(L,z){L.forEach(function(M){if(M.isIntersecting){const T=M.target.querySelector("video source"),S=M.target.querySelector("video"),q=M.target.querySelector("iframe");if(S&&T&&(T.src=T.dataset.source,S.load(),S.addEventListener("loadeddata",function(){n&&S.play()})),q){let P=q.dataset.srcVideo;q.setAttribute("src",P)}z.unobserve(M.target)}})}let v=e.querySelector(".ecom_video"),w=e.querySelector(".ecom_iframe");r&&v.addEventListener("click",()=>{v.readyState>=m&&(v.paused?v.play():v.pause())}),n&&(l&&l.classList.remove("ecom-overlay"),y&&(y.style.display="none"),h&&(h.style.display="none")),v&&!t&&v.addEventListener("ended",function(){h&&(h.style.display="block"),l&&l.classList.add("ecom-overlay"),y&&(y.style.display="block")}),l&&l.addEventListener("click",()=>{if(this.settings.source=="hosted"||this.settings.source=="uploaded"&&v)h&&(h.style.display="none"),v.autoplay=!0,v.play(),l.classList.remove("ecom-overlay"),y.style.display="none";else if(w){let L=w.getAttribute("src");L.includes("autoplay=0")?L=L.replace("autoplay=0","autoplay=1"):L=L+"&autoplay=1",w.setAttribute("src",L),c?setTimeout(()=>{L=L.replace("autoplay=1","autoplay=0"),w.setAttribute("src",L)},100):(h&&(h.style.display="none"),l.classList.remove("ecom-overlay"),y.style.display="none")}}),v&&(i&&!h&&u(v,t),h&&h.addEventListener("click",function(){h.style.display="none",v.play(),i&&u(v,t)}),a||v.addEventListener("pause",function(){h&&(h.style.display="block"),l&&l.classList.add("ecom-overlay"),y&&(y.style.display="block")}),!o&&l&&v.addEventListener("click",function(){v.pause()})),e.querySelectorAll("[data-ec-tracking-id]").forEach(function(L){L.dataset.ecTrackingId&&L.addEventListener("click",function(){window.Shopify.analytics&&Shopify.analytics.publish("ec_custom_events",{button_id:L.id,tracking_id:L.dataset.ecTrackingId})},{once:!0})});const f=e.querySelector("[ecom-modal]");if(f&&this.settings.image_overlay&&c&&window.EComModal){const L=f.dataset.width,z=f.dataset.height;var k=this.id;new window.EComModal(f,{cssClass:[k,"ecom-core","ecom-core-simulator"],onOpen:function(){var M=document.querySelector(".ecom-modal."+k);if(M){const T=M.querySelector(".ecom-modal-box__content");T.classList.add("ecom-element_video-iframe");const S={width:L,height:z};Object.assign(T.style,S)}},onClose:function(){var M=document.querySelector(".ecom-modal."+k);if(M){const T=M.querySelector(".ecom-element_video-iframe iframe");T&&(T.src="")}}})}
                        ...
                        document.querySelectorAll('.ecom-fsaoyzni8z9').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-fsaoyzni8z9', settings: {"loop":true,"autoplay":true,"player_controls":false,"source":"uploaded"},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-wl06ajsfqt').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-wl06ajsfqt', settings: {"loop":true,"autoplay":true,"player_controls":false,"source":"uploaded"},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-s0m567f3fsk').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-s0m567f3fsk', settings: {"loop":true,"autoplay":true,"player_controls":false,"source":"uploaded"},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-o9ndyc268j').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-o9ndyc268j', settings: {"loop":true,"autoplay":true,"player_controls":false,"source":"uploaded"},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-dhcarkx8tgn').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-dhcarkx8tgn', settings: {"loop":true,"autoplay":true,"player_controls":false,"source":"uploaded"},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-abtu1c4z54k').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-abtu1c4z54k', settings: {"loop":true,"autoplay":true,"player_controls":false,"source":"uploaded"},isLive: true});
                        });
...
if(!this.$el)return;let e=this.$el;this.isLive;var i=this.id;const t=function(){const s=document.querySelectorAll(".ecom-container-lightbox-"+i);s.length&&s.forEach(function(o){const a=o.querySelector("iframe");a!=null&&(a.contentWindow.postMessage('{"method":"pause"}',"*"),a.src="");const r=o.querySelector("video");r!=null&&r.pause()})};if(e&&window.EComModal){var n=e.querySelector("[ecom-modal]");new window.EComModal(n,{cssClass:["ecom-container-lightbox-"+this.id,"ecom-html","ecom-modal","ecommodal-slide"],onOpen:function(){const s=document.querySelectorAll(".ecom-container-lightbox-"+i);s.length&&(s.forEach(function(o){const a=o.querySelector("iframe");if(a!=null){const c=a.src.replace("muted=1","muted=0").replace("mute=1","mute=0");a.src=c}const r=o.querySelector("video");r!=null&&r.play()}),window.dispatchEvent(new CustomEvent("ecom-lightbox-opened",{detail:{id:i,el:s}})))},onClose:t})}t()
                ...
                const handleAnimation = function(_this) {
                    ...
                    $btn_wrapper.forEach(function(btn) {
                        let intervalTime = parseInt(_this.settings.animation_loop_time) * 1000 || 6000,
                            animTime = 1000;window.__ectimmers["ecom-82fcjdqsvy"]["fk88cxkwi"] = setInterval(function() {
...
const s=this.$el;if(!s)return;const _=this.isLive,h=this.settings.show_option_selected?this.settings.show_option_selected:!1,L=this.settings.history_state?this.settings.history_state:!1,v=this.settings.auto_variant_disable,f=this.settings.hide_soldout_variant,k=this.settings.hide_unavaiable_variant,b=this.settings.type,g=s.querySelector('[name="id"]'),l=s.closest(".ecom-product-form--single");if(!l)return;v&&b!=="dropdown"&&l.classList.add("ecom_auto_variant_disable");const y=s.querySelector(".ecom-product-single__variant-picker-container");let T=null;if(!g)return;const x=this.$el.querySelector("#"+g.dataset.jsonProduct);if(!x)return;let m=null;try{m=JSON.parse(x.innerHTML)}catch(e){return}function B(e){if(l.classList.contains("ecom_auto_variant_disable")&&v&&e===null)return;const o=l.querySelector(".ecom-product-single__price--badges");if(o&&o.querySelectorAll("span").forEach(function(t){t.style.display="none"}),e)if(e.available&&e.price<e.compare_at_price){if(o&&o.querySelector(".ecom-product-single__price--badges-sale")){const t=o.querySelector(".ecom-product-single__price--badges-sale");t.style.display="block";let i=0;i=Math.round((e.compare_at_price-e.price)*100/e.compare_at_price),t.dataset.type==="amount"&&(i=window.EComposer.formatMoney(e.compare_at_price-e.price));let r=t.dataset.text;r=r.replace(/\{.*\}/g,i),t.innerHTML=r}}else e.available||o&&(o.querySelector(".ecom-product-single__price--badges-sold-out").style.display="block")}function V(e){const o=l.querySelector(".ecom-product-single__quantity-input");if(o){const t=o&&o.dataset.minValue?parseInt(o.dataset.minValue):"",i=o&&o.dataset.maxValue?parseInt(o.dataset.maxValue):"";if(e)e.available?((!o.value||t&&t>0&&o.value<t)&&(o.value=t),o.removeAttribute("disabled","disabled")):(t&&t>0&&(o.value=t),o.setAttribute("disabled","disabled"));else{o.value=t&&t>0?t:1,o.setAttribute("disabled","disabled");return}const r=e.inventory_quantity,p=e.inventory_policy;let n=i&&i>0?i:9999;e.inventory_management&&p==="deny"&&(n=i&&i>0&&i<r?i:r,(r<t||!o.value||t&&t>0&&o.value<t)&&(o.value=t)),r<1&&p=="continue"&&((!o.value||t&&t>0&&o.value<t)&&(o.value=t),n=i&&i>0?i:999999),(e&&r&&r>t||e&&p=="continue")&&(e.inventory_management&&p==="deny"?n=i&&i>0&&i<r?i:r:e.inventory_management&&p==="continue"&&(n=i&&i>0?i:999999),o.value<t&&(o.value=t)),n<0&&(n=0);let a=parseInt(o.value);!t&&a>n&&(a=n),a=isNaN(a)||!a?1:a,!t&&!e.available&&(a=0),a=a>=0?a:1,o.value=a,o.setAttribute("max",n)}}function P(e){const o=l.querySelectorAll(".ecom-product-single__media--slider");if(o.length&&e)o.forEach(function(t){const i=t.querySelector(".ecom-product-single__media--featured");if(i){const r=i.querySelectorAll(".ecom-product-single__media--image");r&&r.length&&r.forEach(p=>{var a,c,u;if(i.getAttribute("data-priority")==="featured")return;const n=(a=p.dataset.variant_id)==null?void 0:a.split(",");if((n==null?void 0:n.length)&&n.includes(String(e.id))){const d=parseInt(p.dataset.index),$=(u=(c=i==null?void 0:i.ec_splide)==null?void 0:c.index)!=null?u:0;d!=$&&i&&i.ec_splide&&i.ec_splide.go(d)}})}});else if(e&&e.featured_image){const t=l.querySelector(".ecom-product-single__media--single");if(t.querySelector(".ecom-product-single__media--featured").getAttribute("data-priority")==="featured")return;if(t){const r=t.querySelector("img");r&&(r.setAttribute("src",e.featured_image.src),r.setAttribute("alt",e.featured_image.alt),r.setAttribute("srcset",e.featured_image.src))}}}function O(e){const o=l.querySelectorAll(".ecom-product-single__add-to-cart--submit");o.length&&o.forEach(function(t){if(l.classList.contains("ecom_auto_variant_disable")&&v)t.setAttribute("disabled","disabled");else if(e)e.available||e.inventory_management===null?(t.removeAttribute("disabled"),t.querySelector(".ecom-add-to-cart-text")&&(!e.inventory_management||e.inventory_management&&e.inventory_quantity>0?(t.querySelector(".ecom-add-to-cart-text").innerHTML=t.dataset.textAddCart,t.classList.remove("ecom-product-single__pre-order")):e.inventory_quantity<=0&&e.inventory_policy=="continue"&&(t.querySelector(".ecom-add-to-cart-text").innerHTML=t.dataset.textPreOrder,t.classList.add("ecom-product-single__pre-order")))):(t.setAttribute("disabled","disabled"),t.querySelector(".ecom-add-to-cart-text")&&(t.querySelector(".ecom-add-to-cart-text").innerHTML=t.dataset.textOutstock,t.classList.remove("ecom-product-single__pre-order")));else if(t.setAttribute("disabled","disabled"),t.querySelector(".ecom-add-to-cart-text")){let i=!1;y.querySelectorAll(".single-option-selector").forEach(function(r){if(r.value===""){i=!0;return}}),i?t.querySelector(".ecom-add-to-cart-text").innerHTML=t.dataset.textAddCart:t.querySelector(".ecom-add-to-cart-text").innerHTML=t.dataset.textUnavailable}})}function D(e){if(!(l.classList.contains("ecom_auto_variant_disable")&&v)&&e&&e.options.length)for(let o=0;o<e.options.length;o++)l.querySelectorAll(`.ecom-product-single__swatch-item[data-option-index="${o}"][data-value="${e.options[o].replace(/'/g,"'").replace(/"/g,'\\"')}"]`).forEach(t=>{t.parentNode.childNodes.forEach(function(i){i.classList&&(i.classList.remove("ecom-box-active"),i.classList.remove("ecom-button-active"),i.classList.remove("ecom-image-active"))}),t.classList.add("ecom-box-active"),t.classList.add("ecom-button-active"),t.classList.add("ecom-image-active")}),l.querySelectorAll(`select.ecom-product-single__swatch-select[data-option-index="${o}"]`).forEach(function(t){t.value=e.options[o]})}function W(e){const o=l.querySelector(".ecom-product-single__countdown");o&&e&&(_||(o.firstElementChild.style.display=""),o.dataset.showOnSale==="true"?e.compare_at_price>e.price&&e.available?(o.style.display="inherit",o.classList.remove("ecom-placeholder-on-builder-mode")):(_&&(o.style.display="none"),o.classList.add("ecom-placeholder-on-builder-mode"),o.classList.add("ecom-force-show"),o.dataset.ecomPlaceholder="This feature not match with your condition",_||(o.firstElementChild.style.display="none")):(o.classList.remove("ecom-placeholder-on-builder-mode"),o.style.display="inherit"))}function R(e){const o=l.querySelectorAll(".ecom-product-single__media-label");e&&o.length&&o.forEach(function(t){const i=t.querySelector("span.ecom-product-single__media-label-sale");i&&(i.style.display=e.available&&e.compare_at_price&&e.compare_at_price>e.price?"block":"none");const r=t.querySelector(".ecom-product-single__media-label-sold-out");r&&(r.style.display=e.available?"none":"block");const p=t.querySelector(".ecom-product-single__media-label--bage-sale");if(p){const n=p.dataset.labelType;if(e.compare_at_price>e.price){let a=p.dataset.sale,c="";n==="amount"?(c=e.compare_at_price-e.price,p.style.display="inherit",p.innerHTML=a.replace(/\[.*\]/g,window.EComposer.formatMoney(c))):(c=Math.round((e.compare_at_price-e.price)*100/e.compare_at_price),p.style.display="inherit",p.innerHTML=a.replace(/\[.*\]/g,Math.floor(c))),p.style.display=e.available?"inherit":"none"}else p.style.display="none"}})}function Z(e){const o=l.querySelectorAll(".ecom-product-single__price--regular"),t=l.querySelectorAll(".ecom-product-single__price--sale"),i=l.querySelectorAll(".ecom-product-single__price--badges-pecent-wrapper"),r=l.querySelectorAll(".ecom-product_ground-price"),p=l.querySelector(".ecom-unit-price"),n=l.querySelectorAll(".ecom-ground-price_unit-price-measurement");e&&(l.querySelector("shopify-payment-terms")&&l.querySelector("shopify-payment-terms").setAttribute("variant-id",e.id),t.length&&a(t,e),i.length&&i.forEach(function(c){const u=c.dataset.labelType;if(e.compare_at_price&&e.compare_at_price>e.price){let d=Math.round((e.compare_at_price-e.price)/e.compare_at_price*100);u==="amount"&&(d=window.EComposer.formatMoney(e.compare_at_price-e.price)),c.querySelector("span")&&(c.style.display="block",c.querySelector("span").innerText=`-${d}%`)}else c.style.display="none"}),o.length&&o.forEach(function(c){c.innerHTML=window.EComposer.formatMoney(e.compare_at_price),e.compare_at_price>e.price?c.style.display="inherit":c.style.display="none"}),r.length&&(r.forEach(function(c){e.unit_price?(c.style.display="block",p&&(p.style.display="block")):(c.style.display="none",p&&(p.style.display="none"));const u=c.querySelector(".ecom-ground-price_unit-price");u&&(u.innerHTML=window.EComposer.formatMoney(e.unit_price))}),n.length&&n.forEach(function(c){e.unit_price_measurement.reference_value!=1?c.innerHTML=e.unit_price_measurement.reference_value+e.unit_price_measurement.reference_unit:c.innerHTML=e.unit_price_measurement.reference_unit})));function a(c,u){c.forEach(function(d){!u.compare_at_price||u.compare_at_price<u.price?d.classList.add("ecom-product-single__price-normal"):d.classList.remove("ecom-product-single__price-normal"),d.innerHTML=window.EComposer.formatMoney(u.price)})}}function F(e){const o=l.querySelector(".ecom-product-single__variant-attributes--barcode"),t=l.querySelector(".ecom-product-single__variant-attributes--sku");e?(o&&(o.style.removeProperty("display"),o.querySelector(".ecom-product-single__variant-attributes--text").innerHTML=`${e.barcode?e.barcode:"N/A"}`),t&&(t.style.removeProperty("display"),t.querySelector(".ecom-product-single__variant-attributes--text").innerHTML=`${e.sku?e.sku:"N/A"}`)):(o&&(o.style.display="none"),t&&(t.style.display="none"))}function J(e){if(l.classList.contains("ecom_auto_variant_disable")&&v)return;const o=l.querySelectorAll(".ecom-product-single__variant-picker-container");if(!o.length||!e)return!1;g.dispatchEvent(new Event("change")),o.forEach(t=>{t.querySelectorAll(".ecom-product-single__variant-picker--selected-value").forEach(function(n){n.remove()}),v&&l.classList.contains("ecom_auto_variant_disable")&&(l.classList.remove("ecom_auto_variant_disable"),l.querySelectorAll(".ecom-product-single__add-to-cart--submit").forEach(function(n){n.removeAttribute("disabled")}));const i=s.querySelectorAll('.selector-wrapper label[for*="ecom-variant-selector"');if(i.length>0&&i.forEach(n=>{const a=n.textContent;n.childNodes.length&&n.childNodes[0].remove();const c=document.createElement("span");c.className="ecom-product-variant--option-label-text",c.innerText=`${a}${a.endsWith(":")?"":":"}`,n.prepend(c)}),!h)return 1;const r=e.options.length,p=t.querySelectorAll(".selector-wrapper");for(let n=0;n<r;n++)p[n]&&p[n].querySelectorAll("label").forEach(a=>{const c=document.createElement("span");c.className="ecom-product-single__variant-picker--selected-value",c.innerHTML=e.options[n],a.appendChild(c)}),t.querySelectorAll(`.ecom-product-single__picker--option-label[data-option-index="${n}"]`).forEach(function(a){let c=document.createElement("span");c.classList.add("ecom-product-single__variant-picker--selected-value"),c.innerHTML=e.options[n],a.appendChild(c)})})}function I(e){B(e),P(e),O(e),V(e),D(e),Z(e),W(e),F(e),J(e),R(e),l.dispatchEvent(new CustomEvent("ecomVariantChange",{detail:{variant:e}}))}if((!g||!g.classList.contains("ecom-product-single__picker-default-variant"))&&window.EComposer&&window.EComposer.OptionSelectors){let e=function(){const a=o.product.getVariantById(g.value);a&&I(a)},t=function(a,c){const u=m.options.length;let d=null;if(u===2){const $=a===0?1:0,w=l.querySelector(`.ecom-product-single__swatch-item.ecom-button-active[data-option-index="${$}"]`),q=w?w.dataset.value:null;if(!q)return;const A=$===0?m.variants.find(S=>S.option1===q&&S.option2===c):m.variants.find(S=>S.option2===q&&S.option1===c);d=A&&A.featured_image?A.featured_image.src:null}return d};const o=new window.EComposer.OptionSelectors(g.id,{product:m,onVariantSelected:function(a,c){I(a),a&&a.id&&l.querySelectorAll('select[name="id"]').forEach(d=>{d.value=a.id})},enableHistoryState:L,autoVariantDisabled:v});g.addEventListener("swatch",function(a){o.selectVariant(a.target.value)}),g.addEventListener("ecomUpdate",function(){clearTimeout(T),T=setTimeout(e,1e3)});const i={};let r=null;const p=function(a,c=!0){switch(a){case 0:var u="root",d=y.querySelectorAll(".single-option-selector")[0];break;case 1:var u=y.querySelectorAll(".single-option-selector")[0].value,d=y.querySelectorAll(".single-option-selector")[1];break;case 2:var u=y.querySelectorAll(".single-option-selector")[0].value;u+=" / "+y.querySelectorAll(".single-option-selector")[1].value;var d=y.querySelectorAll(".single-option-selector")[2];break}if(!c){const E=l.querySelector(`select[data-option-index="${a}"]`);if(E&&E.classList.contains("ecom-product-single__picker-dropdown-list"))return}if(!!d){var $=d.value;d.innerHTML="";var w=i[u]||[];if(!!w){for(var q=0;q<w.length;q++){var A=w[q],S=document.createElement("option");S.value=A,S.innerHTML=A,d.append(S)}var z=l.querySelector('.ecom-product-single__swatch-select[data-option-index="'+a+'"]');z&&(z.innerHTML=d.innerHTML),l.querySelectorAll('.ecom-product-single__swatch-item[data-option-index="'+a+'"]').forEach(E=>{var C=E.dataset.value;if(b==="image"&&E.querySelector("img")){const N=t(a,C);N&&E.querySelector("img").setAttribute("src",N)}(f||k)&&(C&&w.indexOf(C)!==-1?E.classList.remove("ecom-variant-disable"):E.classList.add("ecom-variant-disable"))}),w.indexOf($)!==-1&&(d.value=$),clearTimeout(r),r=setTimeout(()=>{c&&d.dispatchEvent(new Event("change"))},50)}}},n=function(a){for(var c=0;c<a.variants.length;c++){var u=a.variants[c];if(f?u.available:!0){if(i.root=i.root||[],i.root.push(u.option1),i.root=EComposer.uniq(i.root),a.options.length>1){var d=u.option1;i[d]=i[d]||[],i[d].push(u.option2),i[d]=EComposer.uniq(i[d])}if(a.options.length===3){var d=u.option1+" / "+u.option2;i[d]=i[d]||[],i[d].push(u.option3),i[d]=EComposer.uniq(i[d])}}}p(0,u),a.options.length>1&&p(1),a.options.length===3&&p(2);var $=y.querySelectorAll(".single-option-selector")[0];$&&$.addEventListener("change",function(q){return a.options.length>1&&p(1),a.options.length===3&&p(2),!0});var w=y.querySelectorAll(".single-option-selector")[1];w&&w.addEventListener("change",function(q){return p(0,!1),a.options.length===3&&p(2),!0})};if(window.MutationObserver&&l&&(b==="image"||f||k)){typeof M=="object"&&typeof M.disconnect=="function"&&M.disconnect();var U={childList:!0,subtree:!0},M=new MutationObserver(function(){n(m),M.disconnect()});M.observe(l,U)}}if(!this.settings.hasOwnProperty("show_option_selected")&&!this.settings.show_option_selected){const e=s.querySelectorAll('.selector-wrapper label[for*="ecom-variant-selector"');e.length>0&&e.forEach(o=>{const t=o.textContent;o.childNodes.length&&o.childNodes[0].remove();const i=document.createElement("span");i.className="ecom-product-variant--option-label-text",i.innerText=`${t}:`,o.prepend(i)})}l.querySelectorAll(".ecom-product-single__swatch-item[data-option-index]").forEach(e=>{e.addEventListener("click",function(o){o.preventDefault();const t=l.querySelectorAll(".ecom-product-single__media--featured");let i=null;if(!t)return;t.length>1?t.forEach(function(n,a){i||(_?(window.screen.width>1024&&!n.closest(".hide-on-desktop")||window.screen.width>767&&window.screen.width<=1024&&!n.closest(".hide-on-tablet")||window.screen.width<=767&&!n.closest(".hide-on-mobile"))&&(i=n):(window.innerWidth>1024&&!n.closest(".hide-on-desktop")||window.innerWidth>767&&window.innerWidth<=1024&&!n.closest(".hide-on-tablet")||window.innerWidth<=767&&!n.closest(".hide-on-mobile"))&&(i=n))}):i=t[0],i&&i.removeAttribute("data-priority");const r=this;if(this.classList.contains("ecom-button-active")&&this.classList.contains("ecom-image-button"))return;this.parentNode.childNodes.forEach(function(n){n.classList&&(n.classList.remove("ecom-button-active"),n.classList.remove("ecom-image-button"))}),this.classList.add("ecom-button-active"),this.classList.add("ecom-image-button");const p=this.dataset.optionIndex;l.classList.remove("ecom_auto_variant_disable"),l.querySelectorAll("select#"+g.id+"-option-"+p).forEach(function(n){n.value=r.dataset.value,n.dispatchEvent(new Event("change"))})})}),l.querySelectorAll(".ecom-product-single__swatch-select").length?l.querySelectorAll(".ecom-product-single__swatch-select").forEach(function(e){e.addEventListener("change",function(o){const t=l.querySelectorAll(".ecom-product-single__media--featured");let i=null;if(!t)return;t.length>1?t.forEach(function(n,a){i||(window.screen.width>1024&&!n.closest(".hide-on-desktop")||window.screen.width>767&&window.screen.width<=1024&&!n.closest(".hide-on-tablet")||window.screen.width<=767&&!n.closest(".hide-on-mobile"))&&(i=n)}):i=t[0],i&&i.removeAttribute("data-priority");let r=o.target.getAttribute("data-option-index"),p=o.target.value;l.classList.remove("ecom_auto_variant_disable"),l.querySelectorAll("select#"+g.id+"-option-"+r).forEach(function(n){n.value=p,n.dispatchEvent(new Event("change"))})})}):setTimeout(function(){const e=l.querySelectorAll(".ecom-product-single__media--featured");let o=null;!e||(e.length>1?e.forEach(function(t,i){o||(window.screen.width>1024&&!t.closest(".hide-on-desktop")||window.screen.width>767&&window.screen.width<=1024&&!t.closest(".hide-on-tablet")||window.screen.width<=767&&!t.closest(".hide-on-mobile"))&&(o=t)}):o=e[0],o&&o.removeAttribute("data-priority"))},_?500:2500)

                    });
                    
                        document.querySelectorAll('.ecom-6wmiu1m8ir6').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-6wmiu1m8ir6', settings: {"show_option_selected":false,"hide_soldout_variant":true,"hide_unavaiable_variant":true,"type":"image"},isLive: true});
                        });
