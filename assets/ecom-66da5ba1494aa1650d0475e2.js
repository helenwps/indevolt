/* Publish by EComposer at 2025-06-16 03:38:04*/
                (function(){
                    const Func = (function() {
                        'use strict';
                ...
                const handleAnimation = function(_this) {
                    ...
                    $btn_wrapper.forEach(function(btn) {
                        let intervalTime = parseInt(_this.settings.animation_loop_time) * 1000 || 6000,
                            animTime = 1000;window.__ectimmers["ecom-82fcjdqsvy"]["apetr5suc"] = setInterval(function() {
