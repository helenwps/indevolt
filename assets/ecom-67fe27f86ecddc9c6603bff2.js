/* Publish by EComposer at 2025-04-21 10:36:18*/
                (function(){
                    const Func = (function() {
                        'use strict';
                ...
                const handleAnimation = function(_this) {
                    ...
                    $btn_wrapper.forEach(function(btn) {
                        let intervalTime = parseInt(_this.settings.animation_loop_time) * 1000 || 6000,
                            animTime = 1000;window.__ectimmers["ecom-xyo1d42a9i"]["875wcuy7t"] = setInterval(function() {
