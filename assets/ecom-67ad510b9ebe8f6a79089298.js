/* Publish by EComposer at 2025-04-08 03:42:43*/
                (function(){
                    const Func = (function() {
                        'use strict';
                ...
                const handleAnimation = function(_this) {
                    ...
                    $btn_wrapper.forEach(function(btn) {
                        let intervalTime = parseInt(_this.settings.animation_loop_time) * 1000 || 6000,
                            animTime = 1000;window.__ectimmers["ecom-m6zl46erhk"]["p96fh8lg9"] = setInterval(function() {
