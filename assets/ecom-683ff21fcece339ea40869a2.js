/* Publish by EComposer at 2025-06-09 06:52:54*/
                (function(){
                    const Func = (function() {
                        'use strict';
...
if(!this.$el)return;const e=this.$el,i=e.querySelector(".ecom-text_view-more-btn"),t=e.querySelector(".ecom-text_view-less-btn"),n=e.querySelector(".text-content.ecom-html");!n||(i&&i.addEventListener("click",()=>{n.classList.remove("ecom-text--is-mark"),n.style.maxHeight="",i.style.display="none",t.style.display=""}),t&&t.addEventListener("click",()=>{n.classList.add("ecom-text--is-mark"),n.style.maxHeight="var(--ecom-text-height)",t.style.display="none",i.style.display=""}))
                        ...
                        document.querySelectorAll('.ecom-1ufuxbnd2j2').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-1ufuxbnd2j2', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-bno1mzqn94').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-bno1mzqn94', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-ac4efnugo7t').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-ac4efnugo7t', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-fm1gavlw5rd').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-fm1gavlw5rd', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-kjkwwtyog8').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-kjkwwtyog8', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-makkapoyia').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-makkapoyia', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-6gzfl4ects9').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-6gzfl4ects9', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-wiiz9ernbv').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-wiiz9ernbv', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-6smbpftjmai').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-6smbpftjmai', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-v9wy0ud22c').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-v9wy0ud22c', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-21zkq55j28f').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-21zkq55j28f', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-jh3thwn6v4n').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-jh3thwn6v4n', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-cespyj8qi8').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-cespyj8qi8', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-gm3gawrt4zs').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-gm3gawrt4zs', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-4wco6sgx5ur').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-4wco6sgx5ur', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-ahitnqx5x2d').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-ahitnqx5x2d', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-w1is9sbpln').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-w1is9sbpln', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-b3p1f2f2bm7').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-b3p1f2f2bm7', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-z03xsywpfa').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-z03xsywpfa', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-krh0g61mjzi').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-krh0g61mjzi', settings: {},isLive: true});
                        });
                        ...
                        document.querySelectorAll('.ecom-sh8dsdm2afo').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-sh8dsdm2afo', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-h1uh1xw4hl6').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-h1uh1xw4hl6', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-yilcl71fuf').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-yilcl71fuf', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-pji0pdq1xd').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-pji0pdq1xd', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-9h8j0m0zl49').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-9h8j0m0zl49', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-ax2aeti1nye').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-ax2aeti1nye', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-n272gg5n56i').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-n272gg5n56i', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-1sh0ma0izs').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-1sh0ma0izs', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-gjx1avuqjdo').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-gjx1avuqjdo', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-3g0sbaoarp4').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-3g0sbaoarp4', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-auhrf5lak8l').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-auhrf5lak8l', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-31yez5k1jya').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-31yez5k1jya', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-yl1b5jqg8ba').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-yl1b5jqg8ba', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-nw563otl4s').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-nw563otl4s', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-krht72qd2m').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-krht72qd2m', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-ctvasxs4lm5').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-ctvasxs4lm5', settings: {},isLive: true});
                        });
                        ...
                        document.querySelectorAll('.ecom-qof48qqww').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-qof48qqww', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-qyadekpxjks').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-qyadekpxjks', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-w425tq3td69').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-w425tq3td69', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-yxcvfycwey').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-yxcvfycwey', settings: {},isLive: true});
                        });
                        ...
                        document.querySelectorAll('.ecom-ju04ewrpnwf').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-ju04ewrpnwf', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-94ypfzimj1c').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-94ypfzimj1c', settings: {},isLive: true});
                        });
                ...
                const handleAnimation = function(_this) {
                    ...
                    $btn_wrapper.forEach(function(btn) {
                        let intervalTime = parseInt(_this.settings.animation_loop_time) * 1000 || 6000,
                            animTime = 1000;window.__ectimmers["ecom-m6zl46erhk"]["ef4qy3xl5"] = setInterval(function() {
