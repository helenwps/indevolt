/* Publish by EComposer at 2025-04-09 09:56:22*/
                (function(){
                    const Func = (function() {
                        'use strict';
...
if(!this.$el)return;const e=this.$el,t=e.querySelector(".ecom-text_view-more-btn"),i=e.querySelector(".ecom-text_view-less-btn"),o=e.querySelector(".text-content.ecom-html");!o||(t&&t.addEventListener("click",()=>{o.classList.remove("ecom-text--is-mark"),o.style.maxHeight="",t.style.display="none",i.style.display=""}),i&&i.addEventListener("click",()=>{o.classList.add("ecom-text--is-mark"),o.style.maxHeight="var(--ecom-text-height)",i.style.display="none",t.style.display=""}))
                        ...
                        document.querySelectorAll('.ecom-s2avwuk0vc').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-s2avwuk0vc', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-cigfg3mkfmt').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-cigfg3mkfmt', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-47p28nvj3gh').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-47p28nvj3gh', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-4ksjrfhdivr').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-4ksjrfhdivr', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-ck3vc4c38ad').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-ck3vc4c38ad', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-wiocqgxcv').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-wiocqgxcv', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-1sbbr080gbc').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-1sbbr080gbc', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-uzzd3uex1u').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-uzzd3uex1u', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-3jgzkb7ys0w').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-3jgzkb7ys0w', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-ebg3mabgniq').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-ebg3mabgniq', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-k1i1ttrtjge').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-k1i1ttrtjge', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-h3ukioncbtd').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-h3ukioncbtd', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-a96ea1klm9o').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-a96ea1klm9o', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-xlgec55xven').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-xlgec55xven', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-mssvlcm6ag9').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-mssvlcm6ag9', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-veyua6wj73').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-veyua6wj73', settings: {},isLive: true});
                        });
                        ...
                        document.querySelectorAll('.ecom-yb9ljfhzeea').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-yb9ljfhzeea', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-y9q7y1ix8io').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-y9q7y1ix8io', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-4n1be52higd').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-4n1be52higd', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-u0dbm1orcb').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-u0dbm1orcb', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-9v806g0r8i6').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-9v806g0r8i6', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-tvv4h7b2ko').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-tvv4h7b2ko', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-5mlcvralq8e').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-5mlcvralq8e', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-kmccznkd0dg').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-kmccznkd0dg', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-naj7ax2de').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-naj7ax2de', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-9iwm90ib47v').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-9iwm90ib47v', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-z9an6rj0bfg').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-z9an6rj0bfg', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-3qupn9up465').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-3qupn9up465', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-pahjwd6t9d').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-pahjwd6t9d', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-oz6zhy0j8').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-oz6zhy0j8', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-l9beegs6yuo').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-l9beegs6yuo', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-9evimef56ku').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-9evimef56ku', settings: {},isLive: true});
                        });
                    
                        document.querySelectorAll('.ecom-7qaunb2oabn').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-7qaunb2oabn', settings: {},isLive: true});
                        });
...
if(!this.$el)return!1;const e=this.$el;let t=e.closest(".ecom-product-form--single");if(!t){const o=e.closest(".ecom-builder");o&&(t=o.querySelector(".ecom-product-form--single"))}if(!t)return!1;if(this.isLive){let o=t.querySelector("select[name=id]");const s=e.querySelector(".ecom-product-single__buy_it_now_btn--checkout"),n=t.dataset.product_id;if(!n)return;let a=null;const r=t.querySelector("[id^=product-json-"+n+"]");if(!r)return;try{a=JSON.parse(r.innerHTML)}catch(l){return}s&&s.addEventListener("click",function(l){l.preventDefault();let p=1;t.querySelector("[name=quantity]")&&(p=t.querySelector("[name=quantity]").value);let c=t.querySelector("select[name=id]")||t.querySelector("input[name=id]");c||console.warn("EC error: Select id or input id not found!");let m=c.value,B=a.variants.find(u=>u.id==m);if(!B||B.available===!1)return;window.Shopify.analytics&&Shopify.analytics.publish("ec_buy_now",{cartLine:{cost:{totalAmount:{amount:B.price*p,currencyCode:window.Shopify.currency.active}},merchandise:{id:B.id,image:B.image,price:{amount:B.price,currencyCode:window.Shopify.currency.active},product:{id:a.id,title:a.title,vendor:a.vendor},sku:B.sku,title:B.title},quantity:p}});let _=`${window.EComposer.routes.cart_url}/${m}:${p}`;if(window.location.search.includes("selling_plan")){const u=/selling_plan=(\d+)/,d=window.location.search.match(u);if(d){const f=d[1];_=`${window.EComposer.routes.cart_url}/clear?return_to=/cart/add?items[][id]=${m}%26items[][quantity]=${p}%26items[][selling_plan]=${f}%26return_to=/checkout`}}location.href=_}),a.available||(s.classList.add("ecom-disable-buy"),s.disabled=!0),o&&o.addEventListener("change",function(){let l=this.value;if(!l)return;a.variants.find(c=>c.id==l).available===!1?(s.classList.add("ecom-disable-buy"),s.disabled=!0):(s.classList.remove("ecom-disable-buy"),s.disabled=!1)})}const i=function(o){if(!e)return;const s=e.querySelector(".ecom-product-single__buy_it_now_btn--checkout");if(!s)return;let n=parseInt(o.settings.animation_loop_time)*1e3||6e3,a=1e3;window.__ectimmers["ecom-hg8qp0kd16l"]["p1v4eitfx"] = setInterval(function(){s.classList.add("animated"),setTimeout(function(){s.classList.remove("animated")},a)},n)};this.settings.animation&&i(this)
                ...
                (function(){
                    const Func = (function() {
                        'use strict';
window.__ectimmers = window.__ectimmers ||{};window.__ectimmers["ecom-vvgt4tn9wpl"]=  window.__ectimmers["ecom-vvgt4tn9wpl"] || {};
if(!this.$el)return;let e=this.$el;this.isLive;var t=this.id;const i=function(){const s=document.querySelectorAll(".ecom-container-lightbox-"+t);s.length&&s.forEach(function(n){const a=n.querySelector("iframe");a!=null&&(a.contentWindow.postMessage('{"method":"pause"}',"*"),a.src="");const r=n.querySelector("video");r!=null&&r.pause()})};if(e&&window.EComModal){var o=e.querySelector("[ecom-modal]");new window.EComModal(o,{cssClass:["ecom-container-lightbox-"+this.id,"ecom-html","ecom-modal","ecommodal-slide"],onOpen:function(){const s=document.querySelectorAll(".ecom-container-lightbox-"+t);s.length&&s.forEach(function(n){const a=n.querySelector("iframe");if(a!=null){const l=a.src.replace("muted=1","muted=0").replace("mute=1","mute=0");a.src=l}const r=n.querySelector("video");r!=null&&r.play()})},onClose:i})}i()
                        ...
                        document.querySelectorAll('.ecom-vvgt4tn9wpl').forEach(function(el){
                            Func.call({$el: el, id: 'ecom-vvgt4tn9wpl', settings: {},isLive: true});
                        });
                ...
                const handleAnimation = function(_this) {
                    ...
                    $btn_wrapper.forEach(function(btn) {
                        let intervalTime = parseInt(_this.settings.animation_loop_time) * 1000 || 6000,
                            animTime = 1000;window.__ectimmers["ecom-m6zl46erhk"]["zu2juvcdl"] = setInterval(function() {
